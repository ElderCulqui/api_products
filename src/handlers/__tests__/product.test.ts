...
describe('POST /api/products', () => {
    ...
    it('should validate that the price is a number and greater than 0', async () => {
        ...
        expect(response.body.errors[0].msg).toEqual('El precio debe ser un número')
        expect(response.body.errors[1].msg).toEqual('Precio no válido')
    })
...
describe('GET /api/products/:id', () => {
    it('Should return a 404 response for a non-exists product', async () => {
...
describe('PATCH /api/products/:id', () => {
    ...
    it('should update availability an existing product', async () => {
